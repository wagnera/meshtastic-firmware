...
#define meshtastic_LocalModuleConfig_led_matrix_tag 14
...
X(a, STATIC,   OPTIONAL, MESSAGE,  led_matrix,       14)
...
#define meshtastic_LocalModuleConfig_size        613
